                    ...
                    <tr>
						...
						<td>
						                            <div class="d-flex align-items-center gap-2">
						                                ...
						                                <form action="admin-product-update" method="post" enctype="multipart/form-data" class="row g-2 align-items-center m-0">
						                                ...
						                                <a href="admin-product-delete?id=<%= p.getId() %>" class="btn btn-sm btn-danger" onclick="return confirm('Bu ürünü silmek istediğinize emin misiniz?')">Sil</a>
